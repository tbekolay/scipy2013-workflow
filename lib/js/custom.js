...
function feedforward(containerName, workflow, w, h, fontsize, pad) {
    ...
    var svg = d3.selectAll(containerName).append("svg:svg")
        .attr("width", w)
        .attr("height", h);
    ...
    return function() {
        ...
        var x_space = space / (level_w.length - 1);
...
var r2 = feedforward("#workflow-2", advancedWorkflow, 960, 250);
...
Reveal.addEventListener('slidechanged', function( event ) {
    ...
    if (event.indexh === 2 && typeof r1 === 'function') {
        r1 = feedforward("#workflow-1", simpleWorkflow, 960, 140, 34);
        r1();
        r1 = null;
    }
    if (event.indexh === 6 && typeof r2 === 'function') {
    ...
    if (event.indexh === 20 && typeof r3 === 'function') {
